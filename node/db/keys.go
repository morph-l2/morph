...
// Used by SPEC-005 §4.7.6 L1 reorg detection: derivation records the hash of
// each L1 block it has scanned for commit batch logs so a later poll can
// detect a divergence and rewind the cursor.
