...
const HOLESKY_URL = process.env.HOLESKY_RPC_URL || 'https://ethereum-holesky.publicnode.com'
...
module.exports = {
    ...
    networks: {
        ...
        mainnet: {
            url: "https://ethereum.blockpi.network/v1/rpc/b9598c7c9dd8f0344f8889d34b12ba45563f0bc2",
            chainId: 1,
            gas: 'auto',
            gasPrice: 'auto',
            accounts: ['']
