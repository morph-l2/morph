...
import { ZkEvmVerifierV1, Rollup } from "../typechain-types";
...
describe("ZkEvmVerifierV1", async () => {
    ...
    it("should succeed", async () => {
        ...
        // expect(hexlify(publicInputHash)).to.eq("0xf73a7fbae33683a0288671e533083894365d20ac8896a132552146657652f7ae");
...
describe("Rollup", async () => {
    ...
    beforeEach(async () => {
        ...
        rollup = await Rollup.deploy(chainID);
        await rollup.deployed();
    });

    it("should succeed", async () => {
        // let tx = await rollup.commitBatch()
        let res = await rollup.lastCommittedBatchIndex;
