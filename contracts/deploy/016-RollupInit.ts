...
export const RollupInit = async (
    ...
    let MultipleVersionRollupVerifierContract: ethers.Contract
    ...
    if (component.includes('s')) {
        ...
        MultipleVersionRollupVerifierContract = await MultipleVersionRollupVerifierFactory.deploy(version, verifiers)
