...
/**
 * @title  MintManager
 * @notice Set as `owner` of the MORPH token and responsible for the token inflation schedule.
...
contract MintManager is Ownable {
    ...
    /**
     * @notice Only the token owner is allowed to mint a certain amount of MORPH per year.
     *
