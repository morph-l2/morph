...
contract L2GasPriceOracle is OwnableUpgradeable, IL2GasPriceOracle {
    ...
    event IntrinsicParamsUpdated(
        uint256 txGas,
        uint256 txGasContractCreation,
        uint256 zeroGas,
        uint256 nonZeroGas
    );
    ...
    function setL2BaseFee(uint256 _newL2BaseFee) external onlyOwner {
    ...
    function _setIntrinsicParams(
        ...
        require(
            _txGasContractCreation > _txGas,
            "txGasContractCreation is less than txGas"
        );
