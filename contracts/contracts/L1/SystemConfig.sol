...
/**
 * @title SystemConfig
 * @notice The SystemConfig contract is used to manage configuration of an Morph network. All
...
contract SystemConfig is OwnableUpgradeable, Semver {
     ...
     */
    bytes32 public constant UNSAFE_BLOCK_SIGNER_SLOT =
    ...
    /**
     * @notice The configuration for the deposit fee market. Used by the MorphPortal
    ...
    function minimumGasLimit() public view returns (uint64) {
        return
            uint64(_resourceConfig.maxResourceLimit) +
            uint64(_resourceConfig.systemTxMaxGas);
    }
