...
import {
    MorphMintableERC721,
    IMorphMintableERC721
} from "../universal/MorphMintableERC721.sol";

contract MorphMintableERC721_Test is ERC721Bridge_Initializer {
    ERC721 internal L1Token;
    MorphMintableERC721 internal L2Token;
    ...
    function setUp() public override {
        ...
        L2Token = new MorphMintableERC721(
            address(L2Bridge),
            1,
            address(L1Token),
            "L2Token",
    ...
    function test_supportsInterfaces_succeeds() external {
        // Checks if the contract supports the IMorphMintableERC721 interface.
        assertTrue(L2Token.supportsInterface(type(IMorphMintableERC721).interfaceId));
    ...
    function test_safeMint_notBridge_reverts() external {
        ...
        vm.expectRevert("MorphMintableERC721: only bridge can call this function");
