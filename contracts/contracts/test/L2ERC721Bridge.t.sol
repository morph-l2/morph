...
contract TestMintableERC721 is MorphMintableERC721 {
    constructor(address _bridge, address _remoteToken)
        MorphMintableERC721(_bridge, 1, _remoteToken, "Test", "TST")
    {}
...
contract L2ERC721Bridge_Test is Portal_Initializer {
    ...
    function test_finalizeBridgeERC721_interfaceNotCompliant_reverts() external {
        ...
        // to be compliant with the `IMorphMintableERC721` interface.
        vm.mockCall(
            address(L2Messenger),
            abi.encodeWithSelector(L2Messenger.xDomainMessageSender.selector),
            abi.encode(otherBridge)
