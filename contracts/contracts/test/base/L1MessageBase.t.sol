...
//     // staking config
//     event Registered(address addr, bytes32 tmKey, bytes blsKey, uint256 balance);
//     event SequencerUpdated(address[] sequencersAddr, bytes[] sequencersBLS, uint256 version);
//     Staking staking;
...
//         // deploy impls
//         rollupImpl = new Rollup(layer2ChainId, payable(address(l1CrossDomainMessengerProxy)));
...
//         assertEq(_enforcedTxGateway, l1MessageQueueWithGasPriceOracleImpl.enforcedTxGateway());
...
//         assertEq(_enforcedTxGateway, l1MessageQueueWithGasPriceOracle.enforcedTxGateway());
//     }
// }
