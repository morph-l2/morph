    ...
    CrossDomainMessengerLegacySpacer1
{
    ...
    /**
     * @notice Emitted a event associated with message relationship.
     *
     * @param messagerNonce      Address of the withdrawer.
     * @param crossNonce        Address of the recipient on L1.
     */
    event MessageAssociation(uint256 messagerNonce, uint256 crossNonce);
