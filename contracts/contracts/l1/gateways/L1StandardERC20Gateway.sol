...
contract L1StandardERC20Gateway is L1ERC20Gateway {
    ...
    /// @notice The address of MorphStandardERC20 implementation in L2.
    address public l2TokenImplementation;

    /// @notice The address of MorphStandardERC20Factory contract in L2.
    ...
    /// to keep track on whether we have deployed the token in L2 using the L2MorphStandardERC20Factory and
    ...
    /// @param _l2TokenImplementation The address of MorphStandardERC20 implementation in L2.
    /// @param _l2TokenFactory The address of MorphStandardERC20Factory contract in L2.
    function initialize(
