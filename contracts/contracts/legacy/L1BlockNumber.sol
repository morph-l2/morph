 ...
 * @title L1BlockNumber
 * @notice L1BlockNumber is a legacy contract that fills the roll of the L1BlockNumber contract
 *         in the old version of the Morph system. Only necessary for backwards compatibility.
