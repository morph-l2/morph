...
library Predeploys {
     ...
     */
    address internal constant SUBMITTER = 0x5300000000000000000000000000000000000005;
     ...
     */
    address internal constant MORPH_TOKEN = 0x5300000000000000000000000000000000000010;

    /**
     * @notice Address of the RECORD predeploy.
     */
    address internal constant RECORD = 0x5300000000000000000000000000000000000011;

    /**
     * @notice Address of the DISTRIBUTE predeploy.
     */
    address internal constant DISTRIBUTE = 0x5300000000000000000000000000000000000012;

    /**
     * @notice Address of the L2_STAKING predeploy.
     */
    address internal constant L2_STAKING = 0x5300000000000000000000000000000000000013;

    /**
     * @notice Address of the L2_WETH_GATEWAY predeploy.
     */
    address internal constant L2_WETH_GATEWAY = 0x5300000000000000000000000000000000000014;

    /**
     * @notice Address of the L2_WETH predeploy.
     */
    address internal constant L2_WETH = 0x5300000000000000000000000000000000000015;

    /**
     * @notice Address of the L2_SEQUENCER predeploy.
     */
    address internal constant L2_SEQUENCER = 0x5300000000000000000000000000000000000016;

    /**
     * @notice Address of the L2_SUBMITTER predeploy.
     */
    address internal constant L2_SUBMITTER = 0x5300000000000000000000000000000000000017;

    /**
     * @notice Address of the L2_Gov predeploy.
     */
    address internal constant L2_GOV = 0x5300000000000000000000000000000000000018;
}
