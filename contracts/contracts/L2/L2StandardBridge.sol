...
contract L2StandardBridge is StandardBridge, Semver {
     ...
     *         This function only works with MorphMintableERC20 tokens or ether. Use the
    ...
    function _initiateWithdrawal(
        ...
        if (_l2Token == Predeploys.LEGACY_ERC20_ETH) {
            ...
            address l1Token = MorphMintableERC20(_l2Token).l1Token();
    ...
    function _emitERC20BridgeInitiated(
        ...
        emit WithdrawalInitiated(_remoteToken, _localToken, _from, _to, _amount, _extraData, MESSENGER.messageNonce());
