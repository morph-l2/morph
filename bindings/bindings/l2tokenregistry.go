...
// L2TokenRegistryTokenInfo is an auto generated low-level Go binding around an user-defined struct.
type L2TokenRegistryTokenInfo struct {
...
func (_L2TokenRegistry *L2TokenRegistryCaller) GetTokenInfo(opts *bind.CallOpts, _tokenID uint16) (L2TokenRegistryTokenInfo, error) {
	var out []interface{}
	err := _L2TokenRegistry.contract.Call(opts, &out, "getTokenInfo", _tokenID)

	if err != nil {
		return *new(L2TokenRegistryTokenInfo), err
	}

	out0 := *abi.ConvertType(out[0], new(L2TokenRegistryTokenInfo)).(*L2TokenRegistryTokenInfo)
...
//
// Solidity: function getTokenInfo(uint16 _tokenID) view returns((address,bytes32,bool,uint8,uint256))
func (_L2TokenRegistry *L2TokenRegistrySession) GetTokenInfo(_tokenID uint16) (L2TokenRegistryTokenInfo, error) {
...
//
// Solidity: function getTokenInfo(uint16 _tokenID) view returns((address,bytes32,bool,uint8,uint256))
func (_L2TokenRegistry *L2TokenRegistryCallerSession) GetTokenInfo(_tokenID uint16) (L2TokenRegistryTokenInfo, error) {
	return _L2TokenRegistry.Contract.GetTokenInfo(&_L2TokenRegistry.CallOpts, _tokenID)
}
...
func (_L2TokenRegistry *L2TokenRegistryTransactor) DeactivateToken(opts *bind.TransactOpts, _tokenID uint16) (*types.Transaction, error) {
	return _L2TokenRegistry.contract.Transact(opts, "deactivateToken", _tokenID)
}

// DeactivateToken is a paid mutator transaction binding the contract method 0x1684d242.
//
// Solidity: function deactivateToken(uint16 _tokenID) returns()
func (_L2TokenRegistry *L2TokenRegistrySession) DeactivateToken(_tokenID uint16) (*types.Transaction, error) {
	return _L2TokenRegistry.Contract.DeactivateToken(&_L2TokenRegistry.TransactOpts, _tokenID)
}

// DeactivateToken is a paid mutator transaction binding the contract method 0x1684d242.
//
// Solidity: function deactivateToken(uint16 _tokenID) returns()
func (_L2TokenRegistry *L2TokenRegistryTransactorSession) DeactivateToken(_tokenID uint16) (*types.Transaction, error) {
	return _L2TokenRegistry.Contract.DeactivateToken(&_L2TokenRegistry.TransactOpts, _tokenID)
}
