module github.com/morph-l2/tools

go 1.20

require (
	github.com/morph-l2/bindings v0.0.0-20231207064455-3e4859c84c6c
...
replace (
	...
	github.com/scroll-tech/go-ethereum => github.com/morph-l2/go-ethereum v1.10.14-0.20231206022513-be65ab941093
