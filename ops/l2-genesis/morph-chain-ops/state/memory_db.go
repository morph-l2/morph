...
func (db *MemoryStateDB) GetCodeSize(addr common.Address) uint64 {
	...
	return uint64(len(account.Code))
}
...
func (db *MemoryStateDB) PrepareAccessList(rules params.Rules, sender, coinbase common.Address, dest *common.Address, precompiles []common.Address, txAccesses types.AccessList) {
	panic("PrepareAccessList unimplemented")
}
